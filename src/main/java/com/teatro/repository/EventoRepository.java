 ...
 * 
 * Fornece métodos para: - Busca de eventos ativos - Busca por nome - Estatísticas de eventos
 */
@Repository
public interface EventoRepository extends JpaRepository<Evento, Long> {
        ...
        */
       @Query("SELECT e, COUNT(i) as totalIngressos " + "FROM Evento e " + "LEFT JOIN e.sessoes s "
                     + "LEFT JOIN s.ingressos i " + "WHERE e.ativo = true " + "GROUP BY e "
       ...
       /**
        * Verifica se existe evento ativo com ID
        */
        ...
        */
       @Query("SELECT e FROM Evento e " + "WHERE e.ativo = true " + "AND e.sessoes IS EMPTY")
